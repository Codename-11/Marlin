...
#define STRING_CONFIG_H_AUTHOR "(Ender-3, Codename-11)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender-3 Marlin 2.0.X"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -44, -6, -2.47 }
